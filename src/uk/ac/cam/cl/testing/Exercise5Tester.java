...
import uk.ac.cam.cl.ks828.exercises.tick1.*;
import uk.ac.cam.cl.ks828.exercises.tick2.*;
import uk.ac.cam.cl.ks828.exercises.tick3.*;
import uk.ac.cam.cl.ks828.exercises.tick4.*;
import uk.ac.cam.cl.ks828.exercises.tick5.*;
...
public class Exercise5Tester {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Map<Path, Sentiment> dataSet = DataPreparation1.loadSentimentDataset(dataDirectory.resolve("reviews"),
                sentimentFile);
        System.out.println("Tester just made me: " + dataSet.toString());
